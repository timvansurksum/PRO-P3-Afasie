            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="index.php?content=info">meer informatie<span class="sr-only">(current)</span></a>
                    </li>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="index.php?content=game">spel<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
